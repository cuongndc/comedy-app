...
import { useStorage, useDebounce, onClickOutside, set, isClient } from '@vueuse/core';
...
const _imports_0$7 = publicAssetsURL(`icons/header/icon-back-white.svg`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(__props.categories, (cate) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          key: cate.slug,
          class: [slug.value === cate.slug ? "text-red-500 border-red-500" : "text-gray-800", "flex items-center justify-center w-[110px] h-[50px] p-3 border-gray-200 rounded-2xl border text-xl text-center font-normal mx-2 my-2"],
          onClick: ($event) => to(cate.router)
        }, {
...
const _sfc_setup$17 = _sfc_main$18.setup;
...
const TRUYEN_CHU = "truyen-chu";
const DANH_MUC = "danh-muc";
const TRENDING = "trending";
const TRUYEN_CHU_HOT = "truyen-chu-hot";
const NOVEL_DANH_MUC = "novel/danh-muc";
const TAG = "tag";
...
const _sfc_setup$16 = _sfc_main$17.setup;
...
const __nuxt_component_1_lazy$h = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return ComicItem;
}));
const _sfc_main$16 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazyCategorysComicItem = __nuxt_component_1_lazy$h;
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_0$7)} alt="back"${_scopeId}>`);
          } else {
            return [
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$18, { categories: vue_cjs_prod.unref(categories) }, null, _parent));
      if (loading.value) {
        _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$17, { class: "w-[150px] h-[50px]" }, null, _parent));
      } else {
...
const _sfc_setup$15 = _sfc_main$16.setup;
...
const _sfc_setup$14 = _sfc_main$15.setup;
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$15, [["ssrRender", _sfc_ssrRender$a]]);
...
const _sfc_setup$13 = _sfc_main$14.setup;
...
const _sfc_main$13 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SharedMeeToonImg = _sfc_main$14;
...
const _sfc_setup$12 = _sfc_main$13.setup;
...
const _sfc_setup$11 = _sfc_main$12.setup;
...
const _imports_0$6 = publicAssetsURL(`icons/tabbar/icon-newsfeed.svg`);
const _imports_1$4 = publicAssetsURL(`icons/tabbar/icon-toon-active.svg`);
const _imports_2$5 = publicAssetsURL(`icons/tabbar/icon-toon.svg`);
const _imports_3$4 = publicAssetsURL(`icons/tabbar/icon-novel-active.svg`);
const _imports_4$3 = publicAssetsURL(`icons/tabbar/icon-novel.svg`);
const _imports_5$2 = publicAssetsURL(`icons/tabbar/icon-tutruyen.svg`);
const _imports_6$2 = publicAssetsURL(`icons/tabbar/icon-canhan.svg`);
const _sfc_main$11 = {};
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$2;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "max-w-[450px] md:max-w-[768px] flex fixed bottom-0 z-50 bg-white w-full items-center justify-between shadow h-[60px]" }, _attrs))}><div class="w-[20%]"><a class="h-[50px] flex flex-col items-center" title="B\u1EA3ng tin" href="/bang-tin"><div class="w-[30px] max-w-[100%]"><div class="relative pb-[100%]"><img alt="B\u1EA3ng tin" data-src="/icons/tabbar/icon-newsfeed.svg" class="visible h-full left-0 absolute top-0 w-full"${serverRenderer.exports.ssrRenderAttr("src", _imports_0$6)}></div></div><span class="text-xl text-primary-gray">B\u1EA3ng tin</span></a></div><div class="w-[20%]">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "h-[50px] flex flex-col items-center",
    title: "Truy\u1EC7n tranh"
  }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="w-[30px] max-w-[100%]"${_scopeId}><div class="relative pb-[100%]"${_scopeId}>`);
        if (_ctx.$route.name === "index") {
          _push2(`<img alt="Truy\u1EC7n tranh" data-src="/icons/tabbar/icon-toon-active.svg" class="visible h-full left-0 absolute top-0 w-full"${serverRenderer.exports.ssrRenderAttr("src", _imports_1$4)}${_scopeId}>`);
        } else {
          _push2(`<img alt="Truy\u1EC7n tranh" data-src="/icons/tabbar/icon-toon.svg" class="visible h-full left-0 absolute top-0 w-full"${serverRenderer.exports.ssrRenderAttr("src", _imports_2$5)}${_scopeId}>`);
        }
        _push2(`</div></div><span class="${serverRenderer.exports.ssrRenderClass([{ "text-[#059e5d]": _ctx.$route.name === "index" }, "text-primary-gray text-xl"])}"${_scopeId}>Truy\u1EC7n tranh</span>`);
      } else {
        return [
          vue_cjs_prod.createVNode("div", { class: "w-[30px] max-w-[100%]" }, [
            vue_cjs_prod.createVNode("div", { class: "relative pb-[100%]" }, [
              _ctx.$route.name === "index" ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("img", {
                key: 0,
                alt: "Truy\u1EC7n tranh",
                "data-src": "/icons/tabbar/icon-toon-active.svg",
                class: "visible h-full left-0 absolute top-0 w-full",
                src: _imports_1$4
              })) : (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("img", {
                key: 1,
                alt: "Truy\u1EC7n tranh",
          ...
          vue_cjs_prod.createVNode("span", {
            class: ["text-primary-gray text-xl", { "text-[#059e5d]": _ctx.$route.name === "index" }]
          }, "Truy\u1EC7n tranh", 2)
        ];
      }
    }),
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="w-[30px] max-w-[100%]"${_scopeId}><div class="relative pb-[100%]"${_scopeId}>`);
        if (_ctx.$route.name === "novel") {
          _push2(`<img alt="Ti\u1EC3u thuy\u1EBFt" data-src="/icons/tabbar/icon-novel.svg" class="visible h-full left-0 absolute top-0 w-full"${serverRenderer.exports.ssrRenderAttr("src", _imports_3$4)}${_scopeId}>`);
        } else {
          _push2(`<img alt="Ti\u1EC3u thuy\u1EBFt" data-src="/icons/tabbar/icon-novel.svg" class="visible h-full left-0 absolute top-0 w-full"${serverRenderer.exports.ssrRenderAttr("src", _imports_4$3)}${_scopeId}>`);
        }
        _push2(`</div></div><span class="${serverRenderer.exports.ssrRenderClass([{ "text-[#059e5d]": _ctx.$route.name === "novel" }, "text-primary-gray text-xl"])}"${_scopeId}>Truy\u1EC7n ch\u1EEF</span>`);
      } else {
        return [
          vue_cjs_prod.createVNode("div", { class: "w-[30px] max-w-[100%]" }, [
            vue_cjs_prod.createVNode("div", { class: "relative pb-[100%]" }, [
              _ctx.$route.name === "novel" ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("img", {
                key: 0,
                alt: "Ti\u1EC3u thuy\u1EBFt",
          ...
          vue_cjs_prod.createVNode("span", {
            class: ["text-primary-gray text-xl", { "text-[#059e5d]": _ctx.$route.name === "novel" }]
          }, "Truy\u1EC7n ch\u1EEF", 2)
        ];
      }
    }),
  ...
  _push(`</div><div class="w-[20%]"><a class="h-[50px] flex flex-col items-center" title="Gi\xE1 s\xE1ch" href="/gia-sach"><div class="w-[30px] max-w-[100%]"><div class="relative pb-[100%]"><img alt="Gi\xE1 s\xE1ch" data-src="/icons/tabbar/icon-tutruyen.svg" class="visible h-full left-0 absolute top-0 w-full"${serverRenderer.exports.ssrRenderAttr("src", _imports_5$2)}></div></div><span class="text-primary-gray text-xl">Gi\xE1 s\xE1ch</span></a></div><div class="w-[20%]"><a class="h-[50px] flex flex-col items-center" title="C\xE1 nh\xE2n" href="/menu"><div class="w-[30px] max-w-[100%]"><div class="relative pb-[100%]"><img alt="C\xE1 nh\xE2n" data-src="/icons/tabbar/icon-canhan.svg" class="visible h-full left-0 absolute top-0 w-full"${serverRenderer.exports.ssrRenderAttr("src", _imports_6$2)}></div></div><span class="text-primary-gray text-xl">C\xE1 nh\xE2n</span></a></div></div>`);
}
const _sfc_setup$10 = _sfc_main$11.setup;
_sfc_main$11.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/TheFooter.vue");
  return _sfc_setup$10 ? _sfc_setup$10(props, ctx) : void 0;
};
const TheFooter = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["ssrRender", _sfc_ssrRender$9]]);
...
const _sfc_main$10 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: [scrollTransform.value === 0 ? "" : "bg-black/70", "max-w-[450px] md:max-w-[768px] px-4 md:px-12 lg:px-20 xl:px-28 2xl:px-36 px-4 md:px-12 flex items-center h-24 fixed top w-full z-50 transition duration-500 to-transparent"]
      }, _attrs))}><div class="mr-4"></div><div class="flex items-center space-x-4 ml-auto"><form class="flex"><div class="h-full w-fit rounded-2xl p-4 hover:cursor-pointer hover:opacity-60 text-background flex items-center">`);
...
const _sfc_setup$$ = _sfc_main$10.setup;
...
const _sfc_setup$_ = _sfc_main$$.setup;
_sfc_main$$.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pulse/HomeLoading.vue");
  return _sfc_setup$_ ? _sfc_setup$_(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["ssrRender", _sfc_ssrRender$8]]);
const HomeLoading = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": __nuxt_component_0
}, Symbol.toStringTag, { value: "Module" }));
const _imports_0$5 = publicAssetsURL(`icons/menuBar/ranking_v2.png`);
const _imports_1$3 = publicAssetsURL(`icons/menuBar/category_v2.png`);
const _imports_2$4 = publicAssetsURL(`icons/menuBar/follow_v2.png`);
const _imports_3$3 = publicAssetsURL(`icons/menuBar/community_v2.png`);
const _imports_4$2 = publicAssetsURL(`icons/menuBar/mission_v2.png`);
const _sfc_main$_ = {
  __name: "BannerBar",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "py-2 mt-6" }, _attrs))}><div class="grid grid-cols-5"><div class="grid grid-cols-1"><div class="flex items-center justify-center">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="icon w-16 h-16 rounded-[100%] flex items-center justify-center"${_scopeId}><img alt="ranking"${serverRenderer.exports.ssrRenderAttr("src", _imports_0$5)}${_scopeId}></div>`);
          } else {
            return [
      ...
      _push(`</div><p class="text-center text-xl mt-2"> BXH </p></div><div class="grid grid-cols-1"><div class="flex items-center justify-center">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        to: `${vue_cjs_prod.unref(DANH_MUC)}/all`
      }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="icon w-16 h-16 flex items-center justify-center rounded-[100%]"${_scopeId}><img alt="category"${serverRenderer.exports.ssrRenderAttr("src", _imports_1$3)}${_scopeId}></div>`);
          } else {
            return [
      ...
      _push(`</div><p class="text-center text-xl mt-2"> Th\u1EC3 lo\u1EA1i </p></div><div class="grid grid-cols-1"><div class="flex items-center justify-center">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="icon w-16 h-16 rounded-[100%] flex items-center justify-center"${_scopeId}><img alt="category"${serverRenderer.exports.ssrRenderAttr("src", _imports_2$4)}${_scopeId}></div>`);
          } else {
            return [
              vue_cjs_prod.createVNode("div", { class: "icon w-16 h-16 rounded-[100%] flex items-center justify-center" }, [
                vue_cjs_prod.createVNode("img", {
      ...
      _push(`</div><p class="text-center text-xl mt-2"> Theo d\xF5i </p></div><div class="grid grid-cols-1"><div class="flex items-center justify-center">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="icon w-16 h-16 rounded-[100%] flex items-center justify-center"${_scopeId}><img alt="category"${serverRenderer.exports.ssrRenderAttr("src", _imports_3$3)}${_scopeId}></div>`);
          } else {
            return [
              vue_cjs_prod.createVNode("div", { class: "icon w-16 h-16 rounded-[100%] flex items-center justify-center" }, [
                vue_cjs_prod.createVNode("img", {
      ...
      _push(`</div><p class="text-center text-xl mt-2"> H\u1ED9i nh\xF3m </p></div><div class="grid grid-cols-1"><div class="flex items-center justify-center">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="icon w-16 h-16 rounded-[100%] flex items-center justify-center"${_scopeId}><img alt="category"${serverRenderer.exports.ssrRenderAttr("src", _imports_4$2)}${_scopeId}></div>`);
          } else {
            return [
              vue_cjs_prod.createVNode("div", { class: "icon w-16 h-16 rounded-[100%] flex items-center justify-center" }, [
                vue_cjs_prod.createVNode("img", {
      ...
      _push(`</div><p class="text-center text-xl mt-2"> Nhi\u1EC7m v\u1EE5 </p></div></div></div>`);
    };
  }
};
const _sfc_setup$Z = _sfc_main$_.setup;
_sfc_main$_.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/BannerBar.vue");
  return _sfc_setup$Z ? _sfc_setup$Z(props, ctx) : void 0;
};
const BannerBar$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$_
}, Symbol.toStringTag, { value: "Module" }));
const keys$1 = {
...
const __nuxt_component_1_lazy$g = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return Spotlight$3;
}));
const __nuxt_component_3_lazy$5 = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return Trending$3;
}));
const __nuxt_component_4_lazy$3 = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return RepresentCategory$1;
}));
const __nuxt_component_5_lazy$1 = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return NewStory$1;
}));
const _sfc_main$Z = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: homepages, pending } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("home", () => $fetch("/api/homepage"), "$lUPtx2FKUZ")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_PulseHomeLoading = __nuxt_component_0;
      const _component_LazyHomepageSpotlight = __nuxt_component_1_lazy$g;
      const _component_SharedBannerBar = _sfc_main$_;
      const _component_LazyHomepageTrending = __nuxt_component_3_lazy$5;
      const _component_LazyHomepageRepresentCategory = __nuxt_component_4_lazy$3;
      const _component_LazyHomepageNewStory = __nuxt_component_5_lazy$1;
      if (vue_cjs_prod.unref(pending)) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_PulseHomeLoading, _attrs, null, _parent));
      } else {
...
const _sfc_main$Y = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><p class="text-center text-xl mt-2"> BXH </p></div><div class="grid grid-cols-1"><div class="flex items-center justify-center">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        to: `/${vue_cjs_prod.unref(NOVEL_DANH_MUC)}`
      }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="icon w-16 h-16 flex items-center justify-center rounded-[100%]"${_scopeId}><img alt="category"${serverRenderer.exports.ssrRenderAttr("src", _imports_1$3)}${_scopeId}></div>`);
...
_sfc_main$Y.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/BannerBar.vue");
...
const __nuxt_component_1_lazy$f = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return Spotlight$1;
}));
const __nuxt_component_3_lazy$4 = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return Trending$1;
}));
...
const _sfc_main$X = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: homepages, pending } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("novel", () => $fetch("/api/home-novel"), "$widxVJ6ega")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_PulseHomeLoading = __nuxt_component_0;
      const _component_LazyNovelsSpotlight = __nuxt_component_1_lazy$f;
      const _component_NovelsBannerBar = _sfc_main$Y;
      const _component_LazyNovelsTrending = __nuxt_component_3_lazy$4;
      const _component_LazyNovelsRepresentCategory = __nuxt_component_4_lazy$2;
      const _component_LazyNovelsNewStory = __nuxt_component_5_lazy;
      if (vue_cjs_prod.unref(pending)) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_PulseHomeLoading, _attrs, null, _parent));
      } else {
        _push(`<main${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "h-[auto] bg-white" }, _attrs))}><!--[-->`);
        serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(homepages).data, (record) => {
          _push(`<div>`);
          if (record.type === vue_cjs_prod.unref(HomePageTypes)._banner) {
            _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNovelsSpotlight, { banner: record }, null, _parent));
          } else {
            _push(`<!---->`);
          }
          if (record.type === vue_cjs_prod.unref(HomePageTypes)._menu) {
            _push(serverRenderer.exports.ssrRenderComponent(_component_NovelsBannerBar, null, null, _parent));
          } else {
            _push(`<!---->`);
          }
          if (record.type === vue_cjs_prod.unref(HomePageTypes)._hottest_in_week) {
            _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNovelsTrending, { record }, null, _parent));
          } else {
            _push(`<!---->`);
          }
          if (record.type === vue_cjs_prod.unref(HomePageTypes)._representCategory) {
            _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNovelsRepresentCategory, { record }, null, _parent));
          } else {
            _push(`<!---->`);
          }
          if (record.type === vue_cjs_prod.unref(HomePageTypes)._newest || record.type === vue_cjs_prod.unref(HomePageTypes)._recommendation) {
            _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNovelsNewStory, { record }, null, _parent));
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
...
_sfc_main$X.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/TheNovel.vue");
  return _sfc_setup$W ? _sfc_setup$W(props, ctx) : void 0;
};
const TheNovel = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$X
}, Symbol.toStringTag, { value: "Module" }));
...
const Catelog = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["ssrRender", _sfc_ssrRender$7]]);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(__props.record.content, (comic) => {
        _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(LazyComicsComicHorizontal), {
          key: comic.slug,
          _id: comic._id,
...
const NewStory$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$S
}, Symbol.toStringTag, { value: "Module" }));
const _imports_5$1 = publicAssetsURL(`icons/comicPage/icon-star.svg`);
...
const _sfc_main$R = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazySharedMeeToonImg = __nuxt_component_1_lazy$e;
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, vue_cjs_prod.mergeProps({
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="inline-block w-[105px] mr-6"${_scopeId}><div class="relative"${_scopeId}><div class="absolute top-[-3px] left-1 w-full z-10"${_scopeId}><span class="inline-block px-3 rounded-xl bg-[#1fcf84] font-semibold text-white text-base my-2"${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[__props.status])}</span></div>`);
              ...
              vue_cjs_prod.createVNode("div", { class: "inline-block w-[105px] mr-6" }, [
                vue_cjs_prod.createVNode("div", { class: "relative" }, [
                  vue_cjs_prod.createVNode("div", { class: "absolute top-[-3px] left-1 w-full z-10" }, [
                    vue_cjs_prod.createVNode("span", { class: "inline-block px-3 rounded-xl bg-[#1fcf84] font-semibold text-white text-base my-2" }, vue_cjs_prod.toDisplayString(vue_cjs_prod.unref(COMIC_STATUS)[__props.status]), 1)
                  ]),
...
const _sfc_main$Q = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    const more = (content) => {
      const ref2 = content.type !== "category" ? `${TAG}/${content.slug}` : `${DANH_MUC}/${content.slug}`;
      return navigateTo(ref2);
    };
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(__props.record.content, (content) => {
        _push(`<div class="px-4"><div class="h-[40px] mb-4 flex justify-between"><h2 class="text-3xl font-bold flex justify-start items-center text-black">${serverRenderer.exports.ssrInterpolate(content.name || content.categoryVietName)}</h2>`);
        ...
        serverRenderer.exports.ssrRenderList(content.comicsReviewNewest, (comic) => {
          ...
          serverRenderer.exports.ssrRenderList(5, (i) => {
            _push(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_5$1)} alt="rating">`);
          });
...
const RepresentCategory$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$Q
}, Symbol.toStringTag, { value: "Module" }));
                ...
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
                      ...
                      default: vue_cjs_prod.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="w-full bottom-0" data-v-742c771b${_scopeId3}>`);
                          ...
                          return [
                            ...
                            (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(cover.animations, (animation) => {
                              return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(_component_nuxt_img, {
                                key: animation.image,
                                preload: "",
                                quality: 40,
                                format: "webp",
...
const Spotlight$2 = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["__scopeId", "data-v-742c771b"]]);
const Spotlight$3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": Spotlight$2
}, Symbol.toStringTag, { value: "Module" }));
const _imports_0$3 = publicAssetsURL(`icons/homePage/icon-view-chapter.svg`);
const _sfc_main$O = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_nuxt_img = __nuxt_component_2$1;
      const _component_shared_mee_toon_img = _sfc_main$14;
      _push(serverRenderer.exports.ssrRenderComponent(_component_client_only, _attrs, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-4 bg-contain mb-4" data-v-8d22a320${_scopeId}><div data-v-8d22a320${_scopeId}>`);
            ...
            _push2(`</div><div class="bg-white px-2 shadow" data-v-8d22a320${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(Swiper), {
              breakpoints: {
                0: {
                  slidesPerView: 1.3,
                ...
                if (_push3) {
                  ...
                  serverRenderer.exports.ssrRenderList(__props.record.content, (content) => {
                    _push3(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(SwiperSlide), {
                      ...
                      default: vue_cjs_prod.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center p-5" data-v-8d22a320${_scopeId3}>`);
                          ...
                          _push4(`<div class="px-5" data-v-8d22a320${_scopeId3}><h3 class="text-xl font-semibold line-clamp-1 mb-1" data-v-8d22a320${_scopeId3}>`);
                          _push4(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
                          ...
                          _push4(`</h3><p class="text-primary-gray mb-3 text-base" data-v-8d22a320${_scopeId3}> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(content.newestChapter)}</p><div class="flex items-center" data-v-8d22a320${_scopeId3}><div class="flex items-center mr-2" data-v-8d22a320${_scopeId3}><img class="w-5 h-5 mr-1"${serverRenderer.exports.ssrRenderAttr("src", _imports_0$3)} alt="view chapter" data-v-8d22a320${_scopeId3}><span class="text-base text-primary-gray" data-v-8d22a320${_scopeId3}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(content.viewCount))}</span></div><div class="flex items-center" data-v-8d22a320${_scopeId3}><img class="mr-1"${serverRenderer.exports.ssrRenderAttr("src", _imports_5$1)} alt="star" data-v-8d22a320${_scopeId3}><span class="text-base" data-v-8d22a320${_scopeId3}>5 </span><span class="text-base text-primary-gray" data-v-8d22a320${_scopeId3}>(${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(content.reviewCount))})</span></div></div></div></div>`);
                        } else {
                          return [
                            vue_cjs_prod.createVNode("div", {
            ...
            _push2(`</div><div class="rounded-b-xl shadow-[0_3px_20px_rgba(0,0,0,10%)] bg-white" data-v-8d22a320${_scopeId}><div data-v-8d22a320${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
              ...
              default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-xl text-primary-gray" data-v-8d22a320${_scopeId2}>Xem t\u1EA5t c\u1EA3</span>`);
                } else {
                  return [
            ...
            return [
              vue_cjs_prod.createVNode("div", { class: "px-4 bg-contain mb-4" }, [
                vue_cjs_prod.createVNode("div", null, [
...
const Trending$2 = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["__scopeId", "data-v-8d22a320"]]);
const Trending$3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": Trending$2
}, Symbol.toStringTag, { value: "Module" }));
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(__props.chapters, (chapter) => {
        _push(`<div class="relative bg-accent-4" style="${serverRenderer.exports.ssrRenderStyle({ "border-bottom": "1px solid rgb(27, 28, 35)" })}"><div class="px-5 py-5 cursor-pointe"><a><h3 class="text-2xl mb-4"><b> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(chapter.chapterNum)}</b></h3><div class="flex"><p class="mr-8 text-primary-gray text-2xl flex items-center">${serverRenderer.exports.ssrInterpolate(new Date(chapter.createdAt).toLocaleDateString())}</p><div class="mr-[17px] flex items-center justify-center text-2xl"><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_9)} alt="view"><span class="text-primary-gray">${serverRenderer.exports.ssrInterpolate(chapter.totalView ? vue_cjs_prod.unref(convertUnit)(chapter.totalView) : 0)}</span></div><div class="mr-8 flex items-center justify-center text-2xl"><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_10)} alt="like"><span class="text-primary-gray">${serverRenderer.exports.ssrInterpolate(chapter.totalLike ? vue_cjs_prod.unref(convertUnit)(chapter.totalLike) : 0)}</span></div><div class="flex items-center justify-center mr-4 text-2xl"><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_11)} alt="comment"><span class="text-primary-gray">${serverRenderer.exports.ssrInterpolate(chapter.totalComment ? vue_cjs_prod.unref(convertUnit)(chapter.totalComment) : 0)}</span></div></div></a></div></div>`);
      });
      _push(`<!--]-->`);
    };
  }
...
_sfc_main$N.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/ChapterTab.vue");
  return _sfc_setup$M ? _sfc_setup$M(props, ctx) : void 0;
};
const ChapterTab = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$N
}, Symbol.toStringTag, { value: "Module" }));
...
const _sfc_main$M = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    const tags = vue_cjs_prod.computed(() => {
      return __props.comic.tags.map((tag) => tag.slug);
    });
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_LazyNovelsRelatedItem = __nuxt_component_0_lazy$3;
      ...
      _push(`<!--]--></div>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNovelsRelatedItem, { tags: vue_cjs_prod.unref(tags) }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main$M.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/InfoTab.vue");
  return _sfc_setup$L ? _sfc_setup$L(props, ctx) : void 0;
};
const InfoTab = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$M
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$L = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "px-4 mb-4 mt-10" }, _attrs))}><h2 class="h-[20px] text-3xl font-bold flex justify-start items-center text-black mb-4"> # ${serverRenderer.exports.ssrInterpolate(__props.record.typeName)}</h2><div class="whitespace-nowrap overflow-x-auto mb-10 scrollbar-hide"><!--[-->`);
      serverRenderer.exports.ssrRenderList(__props.record.content, (novel) => {
        _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(LazyNovelsNovelHorizontal), {
          key: novel.slug,
          _id: novel._id,
...
_sfc_main$L.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/NewStory.vue");
...
function useNavigatorNovel(slug) {
  return `/${TRUYEN_CHU}/${slug}`;
}
...
const _sfc_main$K = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazySharedMeeToonImg = __nuxt_component_1_lazy$d;
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, vue_cjs_prod.mergeProps({
        to: vue_cjs_prod.unref(useNavigatorNovel)(__props.slug),
        title: __props.name
      }, _attrs), {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><h3 class="text-xl line-clamp-1 mt-1 text-black font-semibold"${serverRenderer.exports.ssrRenderAttr("title", __props.name)}${_scopeId}>${serverRenderer.exports.ssrInterpolate(__props.name)}</h3>`);
            if (__props.tags && __props.tags.length > 0) {
              _push2(`<p class="text-primary-gray text-base font-medium line-clamp-1"${_scopeId}> #${serverRenderer.exports.ssrInterpolate(__props.tags[0].name)}</p>`);
            } else {
              _push2(`<p class="text-primary-gray text-base font-medium line-clamp-1"${_scopeId}>#</p>`);
            }
            if (__props.chapNumber) {
              _push2(`<p class="text-primary-gray text-base"${_scopeId}> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(__props.chapNumber)}</p>`);
            } else {
            ...
            return [
              vue_cjs_prod.createVNode("div", { class: "inline-block w-[105px] mr-6" }, [
                ...
                vue_cjs_prod.createVNode("h3", {
                  class: "text-xl line-clamp-1 mt-1 text-black font-semibold",
                  title: __props.name
                }, vue_cjs_prod.toDisplayString(__props.name), 9, ["title"]),
                __props.tags && __props.tags.length > 0 ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("p", {
                  key: 0,
                  class: "text-primary-gray text-base font-medium line-clamp-1"
                }, " #" + vue_cjs_prod.toDisplayString(__props.tags[0].name), 1)) : (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("p", {
                  key: 1,
                  class: "text-primary-gray text-base font-medium line-clamp-1"
                }, "#")),
                __props.chapNumber ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("p", {
...
_sfc_main$K.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/NovelHorizontal.vue");
  return _sfc_setup$J ? _sfc_setup$J(props, ctx) : void 0;
};
const NovelHorizontal = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$K
}, Symbol.toStringTag, { value: "Module" }));
const __nuxt_component_1_lazy$c = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return MeeToonImg;
}));
const _sfc_main$J = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    const comicsRelated = useState("comicsRelated", "$F3PFHQnjEX");
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazySharedMeeToonImg = __nuxt_component_1_lazy$c;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: "px-5 py-5 pb-20",
        style: { "border-top": "3px solid rgb(27, 28, 35)" }
      }, _attrs))}><div class="flex items-center justify-between"><h2 class="text-white font-bold text-3xl mb-7"> \u0110\u1EC1 xu\u1EA5t li\xEAn quan </h2></div><div class="whitespace-nowrap overflow-x-auto scrollbar-hide min-h-[200px]"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(comicsRelated), (comicRelated) => {
        ...
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          to: vue_cjs_prod.unref(useNavigatorNovel)(comicRelated.slug),
        ...
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          ...
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${serverRenderer.exports.ssrInterpolate(comicRelated.name)}`);
            } else {
              return [
                vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString(comicRelated.name), 1)
              ];
            }
          }),
          _: 2
...
_sfc_main$J.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/RelatedItem.vue");
  return _sfc_setup$I ? _sfc_setup$I(props, ctx) : void 0;
};
const RelatedItem = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$J
}, Symbol.toStringTag, { value: "Module" }));
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer.exports.ssrRenderList(__props.record.content, (content) => {
        ...
        _push(`</div>`);
        if (content.novelsReviewNewes && content.novelsReviewNewes.length > 0) {
          _push(`<div class="grid grid-cols-1 md:grid-cols-2 gap-14 mb-10"><!--[-->`);
          serverRenderer.exports.ssrRenderList(content.novelsReviewNewest, (novel) => {
            _push(`<div class="col-span-1 rounded-[8px] p-13 max-w-[384px] w-full h-[138px] bg-white relative shadow-[0_3px_20px_rgba(0,0,0,10%)]"><div class="absolute bottom-[13px] left-[13px]">`);
            _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
              to: vue_cjs_prod.unref(useNavigatorNovel)(novel.slug)
            }, {
              default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<div class="max-w-full w-[105px]"${_scopeId}><div class="relative"${_scopeId}><div class="absolute top-0"${_scopeId}>`);
                  if (!novel.adultContent) {
                    _push2(`<span class="bg-primary rounded-xl text-white text-xl font-bold px-3 py-1 ml-1"${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[novel.status])}</span>`);
                  } else {
                    _push2(`<span class="bg-primary rounded-xl text-white text-xl font-bold px-3 py-1 ml-1"${_scopeId}> 17+ </span>`);
                  }
                  _push2(`</div>`);
                  ...
                  return [
                    vue_cjs_prod.createVNode("div", { class: "max-w-full w-[105px]" }, [
                      vue_cjs_prod.createVNode("div", { class: "relative" }, [
                        vue_cjs_prod.createVNode("div", { class: "absolute top-0" }, [
                          !novel.adultContent ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("span", {
                            key: 0,
                            class: "bg-primary rounded-xl text-white text-xl font-bold px-3 py-1 ml-1"
                          }, vue_cjs_prod.toDisplayString(vue_cjs_prod.unref(COMIC_STATUS)[novel.status]), 1)) : (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("span", {
                            key: 1,
                            class: "bg-primary rounded-xl text-white text-xl font-bold px-3 py-1 ml-1"
                          }, " 17+ "))
                        ]),
            ...
            _push(`</div><div class="ml-[118px] p-4"><h3 class="text-xl font-medium"><a>${serverRenderer.exports.ssrInterpolate(novel == null ? void 0 : novel.name)}</a></h3><div><div class="rating flex items-center"><!--[-->`);
            serverRenderer.exports.ssrRenderList(5, (i) => {
              _push(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_5$1)} alt="rating">`);
            });
            _push(`<!--]--><p class="text-xl">${serverRenderer.exports.ssrInterpolate(novel == null ? void 0 : novel.avgRate)} <span class="text-xl font-semibold text-gray-500"> (369)</span></p></div><a><i class="w-full text-base line-clamp-3"> &quot;${serverRenderer.exports.ssrInterpolate(novel == null ? void 0 : novel.contentReview)}&quot; </i></a><div class="mt-3"><a class="mt-3"><p class="flex items-center justify-start w-full text-gray-500"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_4$1)} class="mr-2" alt="comment"><span class="name text-base font-semibold">${serverRenderer.exports.ssrInterpolate(novel.userComment.name)}</span></p></a></div></div></div></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="whitespace-nowrap overflow-x-auto mb-10 scrollbar-hide"><!--[-->`);
        serverRenderer.exports.ssrRenderList(content.novels, (novel) => {
          _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(LazyNovelsNovelHorizontal), {
            key: novel == null ? void 0 : novel.slug,
            _id: novel == null ? void 0 : novel._id,
            "adult-content": novel == null ? void 0 : novel.adultContent,
            "chap-number": novel == null ? void 0 : novel.newestChapter,
            name: novel == null ? void 0 : novel.name,
            slug: novel == null ? void 0 : novel.slug,
            status: novel == null ? void 0 : novel.status,
            "vertical-logo": novel == null ? void 0 : novel.verticalLogo,
            tags: novel == null ? void 0 : novel.tags
          }, null, _parent));
        });
        _push(`<!--]--></div></div>`);
      });
...
_sfc_main$I.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/RepresentCategory.vue");
            ...
            serverRenderer.exports.ssrRenderList(__props.banner.covers, (cover) => {
              _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(SwiperSlide), {
                ...
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
                      to: vue_cjs_prod.unref(useNavigatorNovel)(cover.slug),
                      class: "relative block h-[65vw] sm:h-[460px] md:[460px]",
                      title: cover.comicName
                    }, {
                      default: vue_cjs_prod.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="w-full bottom-0" data-v-efb7c3e0${_scopeId3}>`);
                          _push4(serverRenderer.exports.ssrRenderComponent(_component_SharedMeeToonImg, {
                            class: "w-full",
                            alt: cover.comicName,
                            src: `${cover.link}`
                          }, null, _parent4, _scopeId3));
                          ...
                          return [
                            ...
                            (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(cover.animations, (animation) => {
                              return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(_component_SharedMeeToonImg, {
                                key: animation.image,
                                class: "w-full bottom-0",
                                alt: cover.comicName,
                                src: `${animation.image}`
...
_sfc_main$H.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/Spotlight.vue");
  return _sfc_setup$G ? _sfc_setup$G(props, ctx) : void 0;
};
const Spotlight = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["__scopeId", "data-v-efb7c3e0"]]);
const Spotlight$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": Spotlight
}, Symbol.toStringTag, { value: "Module" }));
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_client_only, _attrs, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-4 bg-contain mb-4" data-v-5db2f42d${_scopeId}><div data-v-5db2f42d${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { href: "/" }, {
              default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(serverRenderer.exports.ssrRenderComponent(_component_nuxt_img, {
                    ...
                    quality: "100",
                    class: "w-full",
                    src: "/icons/widgets/trend/img-header-novel.svg",
                    alt: "C\xF3 ch\u1EAFc \u0111\xE2y l\xE0 hot"
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
            ...
            _push2(`</div><div class="bg-white px-2 shadow" data-v-5db2f42d${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(Swiper), {
              breakpoints: {
                0: {
                  slidesPerView: 1.3,
                ...
                if (_push3) {
                  ...
                  serverRenderer.exports.ssrRenderList(__props.record.content, (content) => {
                    _push3(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(SwiperSlide), {
                      ...
                      default: vue_cjs_prod.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center p-5" data-v-5db2f42d${_scopeId3}>`);
                          _push4(serverRenderer.exports.ssrRenderComponent(_component_shared_mee_toon_img, {
                            fil: "cover",
                            class: "aspect-[3/4] w-[75px] h-full relative rounded-2xl",
                            width: 75,
                          ...
                          _push4(`<div class="px-5" data-v-5db2f42d${_scopeId3}><h3 class="text-xl font-semibold line-clamp-1 mb-1" data-v-5db2f42d${_scopeId3}>`);
                          _push4(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
                            to: vue_cjs_prod.unref(useNavigatorComicPreview)(content.slug, content._id)
                          }, {
                            default: vue_cjs_prod.withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${serverRenderer.exports.ssrInterpolate(content.name)}`);
                              } else {
                                return [
                                  vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString(content.name), 1)
                                ];
                              }
                            }),
                            _: 2
                          }, _parent4, _scopeId3));
                          _push4(`</h3><p class="text-primary-gray mb-3 text-base" data-v-5db2f42d${_scopeId3}> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(content.newestChapter)}</p><div class="flex items-center" data-v-5db2f42d${_scopeId3}><div class="flex items-center mr-2" data-v-5db2f42d${_scopeId3}><img class="w-5 h-5 mr-1"${serverRenderer.exports.ssrRenderAttr("src", _imports_0$3)} alt="view chapter" data-v-5db2f42d${_scopeId3}><span class="text-base text-primary-gray" data-v-5db2f42d${_scopeId3}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(content.viewCount))}</span></div><div class="flex items-center" data-v-5db2f42d${_scopeId3}><img class="mr-1"${serverRenderer.exports.ssrRenderAttr("src", _imports_5$1)} alt="star" data-v-5db2f42d${_scopeId3}><span class="text-base" data-v-5db2f42d${_scopeId3}>5 </span><span class="text-base text-primary-gray" data-v-5db2f42d${_scopeId3}>(${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(content.reviewCount))})</span></div></div></div></div>`);
                        } else {
                          return [
                            vue_cjs_prod.createVNode("div", {
                              class: "flex items-center p-5",
            ...
            _push2(`</div><div class="rounded-b-xl shadow-[0_3px_20px_rgba(0,0,0,10%)] bg-white" data-v-5db2f42d${_scopeId}><div data-v-5db2f42d${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
              to: `/${vue_cjs_prod.unref(TRUYEN_CHU_HOT)}`,
              class: "flex items-center justify-center p-5"
            }, {
              default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-xl text-primary-gray" data-v-5db2f42d${_scopeId2}>Xem t\u1EA5t c\u1EA3</span>`);
                } else {
                  return [
                    vue_cjs_prod.createVNode("span", { class: "text-xl text-primary-gray" }, "Xem t\u1EA5t c\u1EA3")
                  ];
...
_sfc_main$G.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/Trending.vue");
  return _sfc_setup$F ? _sfc_setup$F(props, ctx) : void 0;
};
const Trending = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["__scopeId", "data-v-5db2f42d"]]);
...
const _sfc_main$E = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div>`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(LazyComicsRelated), { tags: vue_cjs_prod.unref(tags) }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
const __nuxt_component_1_lazy$b = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return MeeToonImg;
}));
const _sfc_main$D = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    const comicsRelated = useState("comicsRelated", "$83Bf6yO1tN");
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazySharedMeeToonImg = __nuxt_component_1_lazy$b;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: "px-5 py-5 pb-20",
        style: { "border-top": "3px solid rgb(27, 28, 35)" }
      }, _attrs))}><div class="flex items-center justify-between"><h2 class="text-white font-bold text-3xl mb-7"> \u0110\u1EC1 xu\u1EA5t li\xEAn quan </h2></div><div class="whitespace-nowrap overflow-x-auto scrollbar-hide min-h-[200px]"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(comicsRelated), (comicRelated) => {
        _push(`<div class="inline-block w-[105px] mr-6"><div class="relative"><div class="absolute top-[-3px] left-0 w-full z-10"><span class="inline-block px-3 rounded-xl bg-[#1fcf84] font-semibold text-white text-base">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[comicRelated.status])}</span></div>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
...
const CommentComic = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["ssrRender", _sfc_ssrRender$6]]);
...
const _sfc_main$y = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "grid grid-cols-3" }, _attrs))}><!--[-->`);
      serverRenderer.exports.ssrRenderList(__props.novels, (novel) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          key: novel.slug,
          class: "flex items-center p-4 grid-cols-1",
          to: vue_cjs_prod.unref(useNavigatorNovel)(novel == null ? void 0 : novel.slug)
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="mr-6"${_scopeId}><div class="relative"${_scopeId}><div class="absolute top-[-3px] left-1 w-full z-10"${_scopeId}><span class="inline-block px-3 rounded-xl bg-[#1fcf84] font-semibold text-white text-base my-2"${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[novel.novelStatus])}</span></div>`);
              _push2(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(LazySharedMeeToonImg), {
                alt: novel.name,
                sizes: "sm:100px 2xs:150px md:200px md:250px",
                width: 105,
                height: 140,
              ...
              _push2(`</div><h3 class="text-xl line-clamp-2 mt-1 text-black font-semibold"${serverRenderer.exports.ssrRenderAttr("title", novel.name)}${_scopeId}>${serverRenderer.exports.ssrInterpolate(novel.name)}</h3>`);
              if (novel.tags && novel.tags.length > 0) {
                _push2(`<p class="text-primary-gray text-base font-medium line-clamp-1"${_scopeId}> #${serverRenderer.exports.ssrInterpolate(novel.tags[0].name)}</p>`);
              } else {
                _push2(`<p class="text-primary-gray text-base font-medium line-clamp-1"${_scopeId}> # </p>`);
              }
              if (novel.newestChapter) {
                _push2(`<p class="text-primary-gray text-base"${_scopeId}> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(novel.newestChapter)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              ...
              return [
                vue_cjs_prod.createVNode("div", { class: "mr-6" }, [
                  vue_cjs_prod.createVNode("div", { class: "relative" }, [
                    vue_cjs_prod.createVNode("div", { class: "absolute top-[-3px] left-1 w-full z-10" }, [
                      vue_cjs_prod.createVNode("span", { class: "inline-block px-3 rounded-xl bg-[#1fcf84] font-semibold text-white text-base my-2" }, vue_cjs_prod.toDisplayString(vue_cjs_prod.unref(COMIC_STATUS)[novel.novelStatus]), 1)
                    ]),
                    vue_cjs_prod.createVNode(vue_cjs_prod.unref(LazySharedMeeToonImg), {
                      alt: novel.name,
                      sizes: "sm:100px 2xs:150px md:200px md:250px",
                      width: 105,
                      height: 140,
                  ...
                  vue_cjs_prod.createVNode("h3", {
                    ...
                    title: novel.name
                  }, vue_cjs_prod.toDisplayString(novel.name), 9, ["title"]),
                  novel.tags && novel.tags.length > 0 ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("p", {
                    key: 0,
                    class: "text-primary-gray text-base font-medium line-clamp-1"
                  }, " #" + vue_cjs_prod.toDisplayString(novel.tags[0].name), 1)) : (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("p", {
                    key: 1,
                    class: "text-primary-gray text-base font-medium line-clamp-1"
                  }, " # ")),
                  novel.newestChapter ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("p", {
                    key: 2,
                    class: "text-primary-gray text-base"
                  }, " Ch\u01B0\u01A1ng " + vue_cjs_prod.toDisplayString(novel.newestChapter), 1)) : vue_cjs_prod.createCommentVNode("", true)
                ])
              ];
            }
          }),
...
_sfc_main$y.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/novels/categories/NoveItem.vue");
  return _sfc_setup$x ? _sfc_setup$x(props, ctx) : void 0;
};
const NoveItem = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$y
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$x = {
...
const welcome = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-d2e18222"]]);
...
const nuxtPicture = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["ssrRender", _sfc_ssrRender$5]]);
...
const LazyNovelsNovelHorizontal = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return NovelHorizontal;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return RelatedItem;
}).then((c) => c.default || c));
...
const LazyComicsRelated = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
...
const LazySharedMeeToonImg = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return MeeToonImg;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return HomeLoading;
...
const LazyNovelsCategoriesNoveItem = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return NoveItem;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return welcome$1;
...
const _sfc_main$v = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const slug = vue_cjs_prod.ref(params.slug);
    vue_cjs_prod.ref(false);
    const { data: novels, pending, refresh } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("novels", () => $fetch(`/api/novel/danh-muc/${slug.value}`), "$l8rvCpADIG")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      refresh();
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="bg-white h-[100vh]"><div class="flex justify-between justify-center" style="${serverRenderer.exports.ssrRenderStyle({ "box-shadow": "rgb(242 242 242) 0 -1px 0 inset" })}">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        class: "mx-2 my-2 flex items-center",
        to: "/novel"
      }, {
      ...
      _push(`<div class="flex items-center justify-center w-[70%] mx-2 my-2 text-4xl text-black font-semibold"> #Danh m\u1EE5c truy\u1EC7n ch\u1EEF </div>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        to: "/tim-kiem",
        class: "flex items-center mr-2 h-[40px] w-[30px] mx-2 my-2 rounded-2xl text-white"
      }, {
      ...
      _push(`</div><div class="flex flex-wrap p-4 bg-white">`);
      _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$18, { categories: vue_cjs_prod.unref(novelCategories) }, null, _parent));
      if (!vue_cjs_prod.unref(pending)) {
        _push(`<section class="mt-4 overflow-auto scrollbar-hide" style="${serverRenderer.exports.ssrRenderStyle({ "height": "calc(100vh - 50px)" })}">`);
        _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(LazyNovelsCategoriesNoveItem), { novels: vue_cjs_prod.unref(novels) }, null, _parent));
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main$v.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/novel/danh-muc/[slug].vue");
  return _sfc_setup$u ? _sfc_setup$u(props, ctx) : void 0;
};
const meta$a = void 0;
const _sfc_main$u = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    vue_cjs_prod.ref(false);
    const { data: novels, pending, refresh } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("novels", () => $fetch("/api/novel/danh-muc/all"), "$WJaewrUmsl")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      refresh();
    });
    return (_ctx, _push, _parent, _attrs) => {
...
_sfc_main$u.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/novel/danh-muc/index.vue");
  return _sfc_setup$t ? _sfc_setup$t(props, ctx) : void 0;
};
const meta$9 = void 0;
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
...
const meta$8 = void 0;
const __nuxt_component_1_lazy$a = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return ComicItem;
}));
const _sfc_main$t = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazyCategorysComicItem = __nuxt_component_1_lazy$a;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "bg-white h-[100vh]" }, _attrs))}><div class="flex justify-between justify-center" style="${serverRenderer.exports.ssrRenderStyle({ "box-shadow": "rgb(242 242 242) 0 -1px 0 inset" })}">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "mx-2 my-2 flex items-center"
...
const meta$7 = void 0;
const _imports_0$2 = publicAssetsURL(`icons/searchPage/icon-back.svg`);
const _imports_1$2 = publicAssetsURL(`icons/searchPage/icon-search.svg`);
const _imports_2$3 = publicAssetsURL(`icons/searchPage/icon-close.svg`);
const _imports_2$2 = publicAssetsURL(`icons/searchPage/icon-view-count.svg`);
...
const _sfc_main$s = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_CommonSearchLoading = _sfc_main$17;
      const _component_SharedMeeToonImg = _sfc_main$14;
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_0$2)} alt=""${_scopeId}>`);
          } else {
            return [
              vue_cjs_prod.createVNode("img", {
                src: _imports_0$2,
      ...
      _push(`<div class="flex w-[90%] relative mx-2 my-2"><div class="absolute top-1 left-1"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1$2)} alt=""></div><input${serverRenderer.exports.ssrRenderAttr("value", refInput.value)} class="search-input" placeholder="Nh\u1EADp n\u1ED9i dung t\xECm ki\u1EBFm...">`);
      if (refInput.value.length > 0) {
        _push(`<img class="w-8 h-8 text-primary-gray absolute right-5 top-2.5"${serverRenderer.exports.ssrRenderAttr("src", _imports_2$3)} alt="">`);
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main$r = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data: comics, pending } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("/api/trending", "$4u4pOgvoES")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_SharedMeeToonImg = _sfc_main$14;
      if (vue_cjs_prod.unref(pending)) {
        _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$17, vue_cjs_prod.mergeProps({ class: "w-[150px] h-[50px]" }, _attrs), null, _parent));
      } else {
        _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "bg-white h-[100vh]" }, _attrs))}><div class="flex justify-between justify-center" style="${serverRenderer.exports.ssrRenderStyle({ "box-shadow": "rgb(242 242 242) 0 -1px 0 inset" })}">`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          to: "/",
        ...
        serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(comics), (comic, id) => {
          ...
          _push(`</h3><span class="line-clamp-2 text-primary-gray text-base">${serverRenderer.exports.ssrInterpolate(comic.description)}</span><p class="text-background my-2 text-base"> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(comic.newestChapter)} `);
          if (comic.adultContent) {
            _push(`<span class="text-[red] font-normal pl-2"> 17+ </span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="text-[#2dcb48] font-normal px-2">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[comic.status])}</span></p><div class="flex items-center"><div class="text-primary-gray mb-3 text-base flex items-center mr-4"><img class="mr-1 w-6"${serverRenderer.exports.ssrRenderAttr("src", _imports_2$2)} alt=""><span>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(comic.viewCount))}</span></div><div class="text-primary-gray mb-3 text-base flex items-center"><img class="mr-1"${serverRenderer.exports.ssrRenderAttr("src", _imports_3$2)} alt=""><span> (${serverRenderer.exports.ssrInterpolate(comic.reviewCount)}) </span></div></div></div></div></div>`);
        });
...
const meta$5 = void 0;
const _imports_0$1 = publicAssetsURL(`icons/novelChapterPage/icon-back.svg`);
const _imports_1$1 = publicAssetsURL(`icons/novelChapterPage/icon-arrow-down.svg`);
const _imports_2$1 = publicAssetsURL(`icons/novelChapterPage/icon-report.svg`);
const _imports_3$1 = publicAssetsURL(`icons/novelChapterPage/icon-follow-footer-unactive.svg`);
const _imports_4 = publicAssetsURL(`icons/novelChapterPage/icon-comment.svg`);
const _imports_5 = publicAssetsURL(`icons/novelChapterPage/icon-share.svg`);
const _imports_6$1 = publicAssetsURL(`icons/novelChapterPage/icon-footer-setting.svg`);
const _imports_7$1 = publicAssetsURL(`icons/novelChapterPage/icon-prev.svg`);
const _imports_8 = publicAssetsURL(`icons/novelChapterPage/icon-next.svg`);
...
const _sfc_main$q = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const novelInfo = useState("novelInfo", "$XhypRniTIQ");
    const chapters = useState("chapters", "$yP6fc7Yd2e");
    const shouldShowControl = vue_cjs_prod.ref(true);
    const settingFont = vue_cjs_prod.ref(false);
    const fontDefault = vue_cjs_prod.ref(15);
    const chapterListEL = vue_cjs_prod.ref(null);
    const shouldShowChapterList = vue_cjs_prod.ref(false);
    onClickOutside(chapterListEL, (event) => set(shouldShowChapterList, false));
    const {
      pending,
      data: readPage,
      refresh
    } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyFetch("/api/novel/read-novel", {
      params: {
        slug: chapterSlug.value
      }
    }, "$OQfFs5ofyB")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.onMounted(async () => {
      var _a, _b;
      if (!chapters.value) {
        novelInfo.value = await $fetch("/api/novel/information", {
          params: {
            novelId: (_a = readPage.value) == null ? void 0 : _a.novel._id
          }
        });
        set(chapters, (_b = novelInfo.value) == null ? void 0 : _b.chapters);
      }
    });
    vue_cjs_prod.watchEffect(() => {
      refresh();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vue_cjs_prod.unref(pending)) {
            ...
            if (_push2) {
              _push2(serverRenderer.exports.ssrRenderComponent(_component_Title, null, {
                default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a2, _b2, _c2, _d2;
                  if (_push3) {
                    _push3(`${serverRenderer.exports.ssrInterpolate((_a2 = vue_cjs_prod.unref(readPage).novel) == null ? void 0 : _a2.name)} | Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate((_b2 = vue_cjs_prod.unref(readPage)) == null ? void 0 : _b2.chapter.chapterNum)}`);
                  } else {
                    return [
                      vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString((_c2 = vue_cjs_prod.unref(readPage).novel) == null ? void 0 : _c2.name) + " | Ch\u01B0\u01A1ng " + vue_cjs_prod.toDisplayString((_d2 = vue_cjs_prod.unref(readPage)) == null ? void 0 : _d2.chapter.chapterNum), 1)
                    ];
                  }
                }),
                _: 1
              ...
              return [
                vue_cjs_prod.createVNode(_component_Title, null, {
                  default: vue_cjs_prod.withCtx(() => {
                    var _a2, _b2;
                    return [
                      vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString((_a2 = vue_cjs_prod.unref(readPage).novel) == null ? void 0 : _a2.name) + " | Ch\u01B0\u01A1ng " + vue_cjs_prod.toDisplayString((_b2 = vue_cjs_prod.unref(readPage)) == null ? void 0 : _b2.chapter.chapterNum), 1)
                    ];
                  }),
                  _: 1
                })
        ...
        _push(`<div class="relative flex h-fit flex-1 text-white"><div class="h-fit min-h-screen w-full bg-[#f8f3e6] text-black"><div class="${serverRenderer.exports.ssrRenderClass([{ "top-0": shouldShowControl.value }, "ease-in-out duration-300 fixed top-[-70px] left-0 z-[999] h-[44px] w-full"])}"><div class="flex h-full w-full items-center justify-between text-lg md:text-2xl bg-black/40">`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNuxtLink, {
          to: vue_cjs_prod.unref(useNavigatorNovel)((_a = vue_cjs_prod.unref(readPage).novel) == null ? void 0 : _a.slug),
          class: "w-[30px] h-[30px] flex ml-4"
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_0$1)} alt="back"${_scopeId}>`);
            } else {
              return [
                vue_cjs_prod.createVNode("img", {
                  src: _imports_0$1,
        ...
        _push(`<div class="flex align-center"><span class="text-2xl font-semibold text-white"> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate((_b = vue_cjs_prod.unref(readPage)) == null ? void 0 : _b.chapter.chapterNum)}</span><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1$1)} alt="arrow down"></div><div class="mr-4"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_2$1)} alt="report"></div></div></div><footer class="${serverRenderer.exports.ssrRenderClass([{ "bottom-0": shouldShowControl.value }, "fixed bottom-[-70px] h-[70px] bg-black/40 backdrop-blur-xl w-full ease-in-out duration-300"])}"><div style="${serverRenderer.exports.ssrRenderStyle(!settingFont.value ? null : { display: "none" })}" class="flex justify-around h-full"><div class="flex align-center w-[30px] ml-3"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_3$1)} alt="follow"></div><div class="flex align-center w-[30px]"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_4)} alt="comment"></div><div class="flex align-center w-[30px]"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_5)} alt="share"></div><div class="flex align-center w-[30px]"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_6$1)} alt="setting"></div><div class="flex align-center w-[30px]"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_7$1)} alt="setting"></div><div class="flex align-center w-[30px] mr-3"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_8)} alt="setting"></div></div><div style="${serverRenderer.exports.ssrRenderStyle(settingFont.value ? null : { display: "none" })}" class="setting-font flex items-center justify-around h-full"><div class="flex items-center justify-center w-[95px] h-[30px] border-[1px] border-white rounded-2xl text-white text-center"> A </div><div class="flex items-center justify-center w-[95px] h-[30px] border-[1px] border-white rounded-2xl text-white text-center"> A+ </div><div class="flex items-center justify-center w-[95px] h-[30px] border-[1px] border-white rounded-2xl text-white text-center"> M\u1EB7c \u0111\u1ECBnh </div></div></footer>`);
        if (shouldShowChapterList.value) {
          _push(`<div class="fixed z-[9999] bottom-0 w-full h-full h-[90%] bg-accent-4 overflow-auto scrollbar-hide"><div class="absolute w-full"><div class="rounded-l-2xl rounded-r-2xl px-5 py-5"><h3 class="text-white text-3xl"> Chapters </h3></div><!--[-->`);
          serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(chapters), (chapter) => {
            _push(`<div class="relative" style="${serverRenderer.exports.ssrRenderStyle({ "border-bottom": "1px solid rgb(27, 28, 35)" })}"><div class="px-5 py-5 cursor-pointe"><a><h3 class="text-xl mb-4"><b> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(chapter.chapterNum)}</b></h3><div class="flex"><p class="mr-8 text-primary-gray text-2xl flex items-center">${serverRenderer.exports.ssrInterpolate(new Date(chapter.createdAt).toLocaleDateString())}</p><div class="mr-[17px] flex items-center justify-center text-2xl"><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_9)} alt="view"><span class="text-primary-gray">${serverRenderer.exports.ssrInterpolate(chapter.totalView ? _ctx.convertUnit(chapter.totalView) : 0)}</span></div><div class="mr-8 flex items-center justify-center text-2xl"><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_10)} alt="like"><span class="text-primary-gray">${serverRenderer.exports.ssrInterpolate(chapter.totalLike ? _ctx.convertUnit(chapter.totalLike) : 0)}</span></div><div class="flex items-center justify-center mr-4 text-2xl"><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_11)} alt="comment"><span class="text-primary-gray">${serverRenderer.exports.ssrInterpolate(chapter.totalComment ? _ctx.convertUnit(chapter.totalComment) : 0)}</span></div></div></a></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div><h1 class="px-7 pt-[60px] font-[Literata] text-3xl"> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate((_c = vue_cjs_prod.unref(readPage)) == null ? void 0 : _c.chapter.chapterNum)}: ${serverRenderer.exports.ssrInterpolate(((_d = vue_cjs_prod.unref(readPage)) == null ? void 0 : _d.chapter.chapterName) ? (_e = vue_cjs_prod.unref(readPage)) == null ? void 0 : _e.chapter.chapterName : "...")}</h1><div style="${serverRenderer.exports.ssrRenderStyle({ "font-size": `${fontDefault.value}px` })}" class="px-7 pt-10 chapter-content font-[Literata]">${(_f = vue_cjs_prod.unref(readPage)) == null ? void 0 : _f.chapter.content}</div></div></div></div></div>`);
      }
    };
  }
});
...
_sfc_main$q.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/truyen-chu-chapter/[chapter_slug]/[_id].vue");
  return _sfc_setup$p ? _sfc_setup$p(props, ctx) : void 0;
};
const meta$4 = void 0;
const _sfc_main$p = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  __name: "truyen-chu-hot",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const { data: comics, pending } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("/api/novel/trending", "$fijsEJjDr8")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      if (isClient)
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vue_cjs_prod.unref(pending)) {
        ...
        _push(`<div class="flex items-center justify-center w-[70%] mx-2 my-2 text-4xl text-black font-semibold"> #Truy\u1EC7n ch\u1EEF hot nh\u1EA5t </div>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          to: "/",
          class: "flex items-center mr-2 h-[40px] w-[30px] mx-2 my-2 rounded-2xl text-white"
        }, {
        ...
        _push(`</div><div class="flex flex-wrap bg-white"><section class="mt-4 overflow-auto scrollbar-hide" style="${serverRenderer.exports.ssrRenderStyle({ "height": "calc(100vh - 50px)" })}"><!--[-->`);
        serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(comics), (novel, id) => {
          _push(`<div class="p-4 col-span-1 flex items-center">`);
          if (id === 0) {
            _push(`<div class="text-4xl px-4 text-red-500">${serverRenderer.exports.ssrInterpolate(id + 1)}</div>`);
          } else {
          ...
          _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
            ...
            default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${serverRenderer.exports.ssrInterpolate(novel.name)}`);
              } else {
                return [
                  vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString(novel.name), 1)
                ];
              }
            }),
            _: 2
          }, _parent));
          _push(`</h3><span class="line-clamp-2 text-primary-gray text-base">${serverRenderer.exports.ssrInterpolate(novel.description)}</span><p class="text-background my-2 text-base"> Ch\u01B0\u01A1ng ${serverRenderer.exports.ssrInterpolate(novel.newestChapter)} `);
          if (novel.adultContent) {
            _push(`<span class="text-[red] font-normal pl-2"> 17+ </span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="text-[#2dcb48] font-normal px-2">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[novel.novelStatus])}</span></p><div class="flex items-center"><div class="text-primary-gray mb-3 text-base flex items-center mr-4"><img class="mr-1 w-6"${serverRenderer.exports.ssrRenderAttr("src", _imports_2$2)} alt=""><span>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(novel.viewCount))}</span></div><div class="text-primary-gray mb-3 text-base flex items-center"><img class="mr-1"${serverRenderer.exports.ssrRenderAttr("src", _imports_3$2)} alt=""><span> (${serverRenderer.exports.ssrInterpolate(novel.reviewCount)}) </span></div></div></div></div></div>`);
        });
        _push(`<!--]--></section></div></div>`);
      }
    };
...
_sfc_main$p.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/truyen-chu-hot.vue");
  return _sfc_setup$o ? _sfc_setup$o(props, ctx) : void 0;
};
const meta$3 = void 0;
const _imports_0 = publicAssetsURL(`icons/comicPage/icon-back.svg`);
const _imports_1 = publicAssetsURL(`icons/comicPage/icon-report.svg`);
const _imports_2 = publicAssetsURL(`icons/comicPage/icon-view-count.svg`);
const _imports_3 = publicAssetsURL(`icons/comicPage/icon-follow-count.svg`);
...
const __nuxt_component_3_lazy$3 = vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return ChapterTab;
}));
const _sfc_main$o = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  __name: "[slug]",
  ...
  async setup(__props) {
    ...
    const chapters = useState("chapters", "$mS1ETWgiUx");
    const runtimeConfig = useRuntimeConfig();
    const {
      data: comic,
      pending,
      refresh
    } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("novel-info", () => $fetch(`/api/novel/${slug.value}`), "$JYJhdLBbhU")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.onMounted(async () => {
      if (!comic.value)
        return;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazySharedMeeToonImg = __nuxt_component_1_lazy$8;
      ...
      if (vue_cjs_prod.unref(pending)) {
        ...
        _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "h-[100vh] bg-accent-4" }, _attrs))} data-v-b4a99fdc><div style="${serverRenderer.exports.ssrRenderStyle(backgroundImage((_a = vue_cjs_prod.unref(comic)) == null ? void 0 : _a.verticalLogo))}" class="flex items-center justify-between h-[50px] z-10 fixed top-0 w-full overflow-hidden bg-cover" data-v-b4a99fdc>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          class: "ml-4",
          to: "/novel"
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="back" data-v-b4a99fdc${_scopeId}>`);
            } else {
              return [
                vue_cjs_prod.createVNode("img", {
                  src: _imports_0,
        ...
        _push(`<div class="flex items-center bg-deep-black/50 h-[30px] rounded-2xl px-3 mr-4" data-v-b4a99fdc><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} alt="report" data-v-b4a99fdc><span class="text-white text-2xl" data-v-b4a99fdc>B\xE1o c\xE1o</span></div></div><div class="fixed top-0 w-full max-w-[768px]" data-v-b4a99fdc>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_LazySharedMeeToonImg, {
          class: "relative w-full",
          src: (_b = vue_cjs_prod.unref(comic)) == null ? void 0 : _b.verticalLogo
        }, null, _parent));
        _push(`</div><div class="relative mt-[150px]" data-v-b4a99fdc><div class="px-5" style="${serverRenderer.exports.ssrRenderStyle({ "background": "linear-gradient(rgba(17, 18, 23, 0) 0%, rgba(17, 18, 23, 0.5) 33.85%, rgba(17, 18, 23, 0.8) 68.75%, rgb(17, 18, 23) 100%)" })}" data-v-b4a99fdc><div class="bg-contain p-6 bg-comic flex items-center justify-between rounded-xl" style="${serverRenderer.exports.ssrRenderStyle({ "background-image": "url(/icons/comicPage/backgroundInfo.png)" })}" data-v-b4a99fdc><div class="left" data-v-b4a99fdc><div data-v-b4a99fdc><h1 class="text-ellipsis line-clamp-1 text-3xl font-bold text-white" data-v-b4a99fdc>${serverRenderer.exports.ssrInterpolate((_c = vue_cjs_prod.unref(comic)) == null ? void 0 : _c.name)}</h1></div><div class="flex flex-wrap" data-v-b4a99fdc><div class="my-4 flex items-center justify-center rounded-xl text-[#1fcf84] border-[#1fcf84] text-base border-[1px] h-[20px] w-[80px]" data-v-b4a99fdc>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[(_d = vue_cjs_prod.unref(comic)) == null ? void 0 : _d.novelStatus])}</div><div class="mx-4 my-4 flex items-center text-gray-50 text-base" data-v-b4a99fdc><img${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} alt="view count" data-v-b4a99fdc><span class="ml-1" data-v-b4a99fdc>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)((_e = vue_cjs_prod.unref(comic)) == null ? void 0 : _e.viewCount))}</span></div><div class="mx-4 my-4 flex items-center text-gray-50 text-base" data-v-b4a99fdc><img class="w-[18px] h-[18px]"${serverRenderer.exports.ssrRenderAttr("src", _imports_3)} alt="follow count" data-v-b4a99fdc><span class="ml-1" data-v-b4a99fdc>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)((_f = vue_cjs_prod.unref(comic)) == null ? void 0 : _f.followingCount))}</span></div><div class="flex items-center text-base text-gray-50" data-v-b4a99fdc><img${serverRenderer.exports.ssrRenderAttr("src", _imports_4$1)} alt="comment count" data-v-b4a99fdc><span class="ml-1" data-v-b4a99fdc>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)((_g = vue_cjs_prod.unref(comic)) == null ? void 0 : _g.totalComment))}</span></div></div></div><div class="right" data-v-b4a99fdc><div class="w-[80px] text-center cursor-pointer" data-v-b4a99fdc><p class="text-yellow-400 text-4xl" data-v-b4a99fdc> 5 </p><div class="flex items-center justify-center" data-v-b4a99fdc><!--[-->`);
        serverRenderer.exports.ssrRenderList(5, (i) => {
          _push(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_5$1)} alt="rating" data-v-b4a99fdc>`);
        });
        _push(`<!--]--></div><div data-v-b4a99fdc><span class="text-white text-xl" data-v-b4a99fdc>${serverRenderer.exports.ssrInterpolate((_h = vue_cjs_prod.unref(comic)) == null ? void 0 : _h.reviewCount)} \u0110\xE1nh gi\xE1</span></div></div></div></div></div></div><div class="bg-footer-comic_page px-3 fixed bottom-0 w-full h-[60px] max-w-[768px] flex items-center z-50" data-v-b4a99fdc><div class="cursor-pointer" data-v-b4a99fdc><img${serverRenderer.exports.ssrRenderAttr("src", _imports_6)} alt="Chia s\u1EBB" data-v-b4a99fdc></div><div class="ml-6 cursor-pointer" data-v-b4a99fdc><img${serverRenderer.exports.ssrRenderAttr("src", _imports_7)} alt="Theo d\xF5i" data-v-b4a99fdc></div><a class="comic-read" data-v-b4a99fdc> B\u1EAFt \u0111\u1EA7u \u0111\u1ECDc </a></div><div class="relative bg-accent-4" data-v-b4a99fdc><div class="whitespace-nowrap overflow-x-auto border-b-[1px solid rgb(27, 28, 35)]" data-v-b4a99fdc><div class="${serverRenderer.exports.ssrRenderClass([{ active: vue_cjs_prod.unref(comicTab) }, "eKaTWX inline-block"])}" data-v-b4a99fdc><span data-v-b4a99fdc>Gi\u1EDBi thi\u1EC7u</span></div><div class="${serverRenderer.exports.ssrRenderClass([{ active: vue_cjs_prod.unref(chapterTab) }, "eKaTWX"])}" data-v-b4a99fdc><a data-v-b4a99fdc>Chapters (${serverRenderer.exports.ssrInterpolate(((_i = vue_cjs_prod.unref(chapters)) == null ? void 0 : _i.length) ? (_j = vue_cjs_prod.unref(chapters)) == null ? void 0 : _j.length : 0)})</a></div><div class="${serverRenderer.exports.ssrRenderClass([{ active: vue_cjs_prod.unref(reviewTab) }, "eKaTWX"])}" data-v-b4a99fdc><a data-v-b4a99fdc>\u0110\xE1nh gi\xE1</a></div></div></div>`);
        if (vue_cjs_prod.unref(comicTab)) {
          _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNovelsInfoTab, { comic: vue_cjs_prod.unref(comic) }, null, _parent));
        } else {
          _push(`<!---->`);
        }
        if (vue_cjs_prod.unref(chapterTab)) {
          _push(serverRenderer.exports.ssrRenderComponent(_component_LazyNovelsChapterTab, { chapters: vue_cjs_prod.unref(chapters) }, null, _parent));
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
...
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/truyen-chu/[slug].vue");
  return _sfc_setup$n ? _sfc_setup$n(props, ctx) : void 0;
};
const meta$2 = {
  pageTransition: {
...
const _sfc_main$n = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const params = route.params;
    const chapterSlug = vue_cjs_prod.ref(params.chapter_slug);
    const chapters = useState("chapters", "$74IzEIQ5aP");
    const {
      pending,
      data: readPage,
      refresh
    ...
    }, "$Bh5OFOplA1")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.onMounted(async () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LazyMangaReadMangaFooter = __nuxt_component_4_lazy$1;
      if (vue_cjs_prod.unref(pending)) {
        _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_CommonPageLoading, null, null, _parent));
        _push(`</div>`);
...
const _sfc_main$m = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const tab = vue_cjs_prod.ref("comic");
    const chapters = useState("chapters", "$KB1XoeGJDE");
    const runtimeConfig = useRuntimeConfig();
    const {
      data: comic,
      pending,
      refresh
    } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch(`/api/comic/${slug.value}/${_id.value}`, "$aWDrouH4S5")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.onMounted(async () => {
      var _a;
      if (!comic.value)
        return;
      chapters.value = await $fetch("/api/chapters", {
        params: {
          comic_slug: (_a = comic.value) == null ? void 0 : _a.slug
        }
      });
    });
    vue_cjs_prod.watchEffect(async () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vue_cjs_prod.unref(pending)) {
        _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)} data-v-75a72620>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_CommonPageLoading, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "h-[100vh] bg-accent-4" }, _attrs))} data-v-75a72620><div style="${serverRenderer.exports.ssrRenderStyle(backgroundImage(vue_cjs_prod.unref(comic).squareCover))}" class="flex items-center justify-between h-[50px] z-10 fixed top-0 w-full overflow-hidden bg-cover" data-v-75a72620>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          class: "ml-4",
          onClick: ($event) => _ctx.$router.back()
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="back" data-v-75a72620${_scopeId}>`);
            } else {
              return [
                vue_cjs_prod.createVNode("img", {
                  src: _imports_0,
        ...
        _push(`<div class="flex items-center bg-deep-black/50 h-[30px] rounded-2xl px-3 mr-4" data-v-75a72620><img class="mr-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} alt="report" data-v-75a72620><span class="text-white text-2xl" data-v-75a72620>B\xE1o c\xE1o</span></div></div><div class="fixed top-0 w-full max-w-[768px]" data-v-75a72620>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_LazySharedMeeToonImg, {
          class: "relative w-full",
          src: vue_cjs_prod.unref(comic).squareCover
        }, null, _parent));
        _push(`</div><div class="relative mt-[150px]" data-v-75a72620><div class="px-5" style="${serverRenderer.exports.ssrRenderStyle({ "background": "linear-gradient(rgba(17, 18, 23, 0) 0%, rgba(17, 18, 23, 0.5) 33.85%, rgba(17, 18, 23, 0.8) 68.75%, rgb(17, 18, 23) 100%)" })}" data-v-75a72620><div class="bg-contain p-6 bg-comic flex items-center justify-between rounded-xl" style="${serverRenderer.exports.ssrRenderStyle({ "background-image": "url(/icons/comicPage/backgroundInfo.png)" })}" data-v-75a72620><div class="left" data-v-75a72620><div data-v-75a72620><h1 class="text-ellipsis line-clamp-1 text-3xl font-bold text-white" data-v-75a72620>${serverRenderer.exports.ssrInterpolate((_a = vue_cjs_prod.unref(comic)) == null ? void 0 : _a.comicName)}</h1></div><div class="flex flex-wrap" data-v-75a72620><div class="my-4 flex items-center justify-center rounded-xl text-[#1fcf84] border-[#1fcf84] text-base border-[1px] h-[20px] w-[80px]" data-v-75a72620>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(COMIC_STATUS)[(_b = vue_cjs_prod.unref(comic)) == null ? void 0 : _b.status])}</div><div class="mx-4 my-4 flex items-center text-gray-50 text-base" data-v-75a72620><img${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} alt="view count" data-v-75a72620><span class="ml-1" data-v-75a72620>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(vue_cjs_prod.unref(comic).viewCount))}</span></div><div class="mx-4 my-4 flex items-center text-gray-50 text-base" data-v-75a72620><img class="w-[18px] h-[18px]"${serverRenderer.exports.ssrRenderAttr("src", _imports_3)} alt="follow count" data-v-75a72620><span class="ml-1" data-v-75a72620>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(vue_cjs_prod.unref(comic).followingCount))}</span></div><div class="flex items-center text-base text-gray-50" data-v-75a72620><img${serverRenderer.exports.ssrRenderAttr("src", _imports_4$1)} alt="comment count" data-v-75a72620><span class="ml-1" data-v-75a72620>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(convertUnit)(vue_cjs_prod.unref(comic).totalComment))}</span></div></div></div><div class="right" data-v-75a72620><div class="w-[80px] text-center cursor-pointer" data-v-75a72620><p class="text-yellow-400 text-4xl" data-v-75a72620> 5 </p><div class="flex items-center justify-center" data-v-75a72620><!--[-->`);
        serverRenderer.exports.ssrRenderList(5, (i) => {
          _push(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_5$1)} alt="rating" data-v-75a72620>`);
        });
        ...
        if (vue_cjs_prod.unref(comicTab)) {
          _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$E, { comic: vue_cjs_prod.unref(comic) }, null, _parent));
        } else {
          _push(`<!---->`);
        }
        if (vue_cjs_prod.unref(chapterTab)) {
          _push(serverRenderer.exports.ssrRenderComponent(_sfc_main$F, { chapters: vue_cjs_prod.unref(chapters) }, null, _parent));
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
...
const routes = [
  ...
  {
    name: "novel-danh-muc-slug",
    path: "/novel/danh-muc/:slug",
    file: "/Users/bonn/Documents/GitHub/comedy-app/pages/novel/danh-muc/[slug].vue",
    children: [],
    meta: meta$a,
    alias: [],
    component: () => Promise.resolve().then(function() {
  ...
  },
  {
    name: "novel-danh-muc",
    path: "/novel/danh-muc",
    file: "/Users/bonn/Documents/GitHub/comedy-app/pages/novel/danh-muc/index.vue",
    children: [],
    meta: meta$9,
    alias: [],
    component: () => Promise.resolve().then(function() {
  ...
  },
  {
    name: "novel",
    path: "/novel",
    file: "/Users/bonn/Documents/GitHub/comedy-app/pages/novel/index.vue",
    children: [],
    meta: meta$8,
    alias: [],
    component: () => Promise.resolve().then(function() {
  ...
  {
    name: "truyen-chu-chapter-chapter_slug-_id",
    path: "/truyen-chu-chapter/:chapter_slug/:_id",
    file: "/Users/bonn/Documents/GitHub/comedy-app/pages/truyen-chu-chapter/[chapter_slug]/[_id].vue",
    children: [],
    meta: meta$4,
    alias: [],
    component: () => Promise.resolve().then(function() {
  ...
  },
  {
    name: "truyen-chu-hot",
    path: "/truyen-chu-hot",
    file: "/Users/bonn/Documents/GitHub/comedy-app/pages/truyen-chu-hot.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => Promise.resolve().then(function() {
  ...
  {
    name: "truyen-chu-slug",
    path: "/truyen-chu/:slug",
    file: "/Users/bonn/Documents/GitHub/comedy-app/pages/truyen-chu/[slug].vue",
    children: [],
    meta: meta$2,
...
const _sfc_main$k = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(_sfc_main$12), null, null, _parent));
...
const plugins = normalizePlugins(_plugins);
{
  entry = async function createNuxtAppServer(ssrContext) {
    ...
    vueApp.component("App", _sfc_main$k);
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "_layout max-w-[450px] md:max-w-[768px] mx-auto h-[100vh]" }, _attrs))}>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$4]]);
...
const manga = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["ssrRender", _sfc_ssrRender$3]]);
...
const menu = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main$g = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazyCategorysComicItem = __nuxt_component_1_lazy$6;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "bg-white h-[100vh]" }, _attrs))}><div class="flex justify-between justify-center" style="${serverRenderer.exports.ssrRenderStyle({ "box-shadow": "rgb(242 242 242) 0 -1px 0 inset" })}">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "mx-2 my-2 flex items-center"
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  const _component_LazyTheHome = __nuxt_component_1_lazy$5;
...
const index$4 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$1]]);
...
const _sfc_main$e = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const slug = vue_cjs_prod.ref(params.slug);
    vue_cjs_prod.ref(false);
    const { data: novels, pending, refresh } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("novels", () => $fetch(`/api/novel/danh-muc/${slug.value}`), "$uwN93nAqwe")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      refresh();
    });
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$d = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    vue_cjs_prod.ref(false);
    const { data: novels, pending, refresh } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("novels", () => $fetch("/api/novel/danh-muc/all"), "$YUP53AaX7U")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      refresh();
    });
    return (_ctx, _push, _parent, _attrs) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLayout = __nuxt_component_0$1;
  const _component_LazyTheNovel = __nuxt_component_1_lazy$4;
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, _attrs, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(serverRenderer.exports.ssrRenderComponent(_component_LazyTheNovel, null, null, _parent2, _scopeId));
      } else {
        return [
          vue_cjs_prod.createVNode(_component_LazyTheNovel)
        ];
      }
    }),
    _: 1
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/novel/index.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const index$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender]]);
...
const _sfc_main$9 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data: comics, pending } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("/api/trending", "$YTq7nv4xSJ")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_SharedMeeToonImg = _sfc_main$14;
      if (vue_cjs_prod.unref(pending)) {
...
const _sfc_main$8 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const params = route.params;
    const chapterSlug = vue_cjs_prod.ref(params.chapter_slug);
    useState("novelInfo", "$7S0cX2BVCD");
    const chapters = useState("chapters", "$45AsQNQXaO");
    const shouldShowControl = vue_cjs_prod.ref(true);
    const settingFont = vue_cjs_prod.ref(false);
    const fontDefault = vue_cjs_prod.ref(15);
    const chapterListEL = vue_cjs_prod.ref(null);
    ...
    }, "$MNPzomig8L")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      refresh();
    });
    return (_ctx, _push, _parent, _attrs) => {
...
const __id_$3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$8
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$7 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data: comics, pending } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("/api/novel/trending", "$tgsV5hA6DG")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      if (isClient)
        window.scrollTo({ top: 0, behavior: "smooth" });
    });
...
const truyenChuHot = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$7
}, Symbol.toStringTag, { value: "Module" }));
...
const _sfc_main$6 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const slug = vue_cjs_prod.ref(params.slug);
    const tab = vue_cjs_prod.ref("comic");
    const chapters = useState("chapters", "$wuX2hidpng");
    const runtimeConfig = useRuntimeConfig();
    const {
      data: comic,
      pending,
      refresh
    } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useLazyAsyncData("novel-info", () => $fetch(`/api/novel/${slug.value}`), "$X4LcmzhNik")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(async () => {
      if (isClient)
        window.scrollTo({ top: 0, behavior: "smooth" });
      await refresh();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j;
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_LazySharedMeeToonImg = __nuxt_component_1_lazy$1;
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-b4a99fdc"]]);
...
const _sfc_main$5 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const params = route.params;
    const chapterSlug = vue_cjs_prod.ref(params.chapter_slug);
    const chapters = useState("chapters", "$hEduIqwgaM");
    const {
      pending,
      data: readPage,
      refresh
    ...
    }, "$dTzZwZ1010")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(() => {
      refresh();
    });
    const handleChapter = async (action) => {
...
const _sfc_main$4 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const _id = vue_cjs_prod.ref(params._id);
    const tab = vue_cjs_prod.ref("comic");
    const chapters = useState("chapters", "$cwBZJIR1dJ");
    const runtimeConfig = useRuntimeConfig();
    const {
      data: comic,
      pending,
      refresh
    } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch(`/api/comic/${slug.value}/${_id.value}`, "$NSgnwJ3ZyN")), __temp = await __temp, __restore(), __temp);
    vue_cjs_prod.watchEffect(async () => {
      if (isClient)
        window.scrollTo({ top: 0, behavior: "smooth" });
      await refresh();
...
const __id_ = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-75a72620"]]);
