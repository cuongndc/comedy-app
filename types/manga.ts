import type { Chapter, Genre } from './chapter'
import type { DropDownLink } from '~/contants'
...
export interface IManga extends SearchResponseData {
  status: Status
  author: string
  otherName: string
  review: string
