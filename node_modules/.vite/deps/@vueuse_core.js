...
function useDraggable(target, options = {}) {
  ...
  return __spreadProps$42(__spreadValues$d({}, toRefs(position)), {
    position,
...
function useFetch(url, ...args) {
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    const context = { url: unref2(url), options: __spreadValues$b(__spreadValues$b({}, defaultFetchOptions), fetchOptions), cancel: () => {
      isCanceled = true;
    } };
...
function useFileSystemAccess(options = {}) {
  ...
  async function open(_options = {}) {
    if (!isSupported)
      return;
    const [handle] = await window2.showOpenFilePicker(__spreadValues$92(__spreadValues$92({}, unref2(options)), _options));
  ...
  async function create(_options = {}) {
    if (!isSupported)
      return;
    fileHandle.value = await window2.showSaveFilePicker(__spreadValues$92(__spreadValues$92({}, unref2(options)), _options));
    data.value = void 0;
    await updateFile();
    await updateData();
  }
